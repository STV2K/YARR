...
def feature_sharing_block(inp):
    ...
    deconv_part = deconv_block(resnet_part.residual_layers, in_planes=resnet_out.size()[1])
...
def deconv_block(residual_layers, in_planes, repeat=3, channel_shrunk_factor=2):
