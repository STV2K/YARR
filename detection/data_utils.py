    ...
    while True:
        ...
        for i in index:
            try:
                ...
                im = im.resize((h * rd_scale, w * rd_scale), Image.ANTIALIAS)
                text_polys *= rd_scale
                # print rd_scale
                ...
                if np.random.rand() < background_ratio:
                    ...
                    im = im_padded.resize((input_size, input_size), Image.ANTIALIAS)
                    ...
                    im = im.resize((resize_w, resize_h), Image.ANTIALIAS)
